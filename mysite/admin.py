...
from .models import TokenType, Token, Language, Theme, Client, Translation, ClientLanguage, ClientTheme, TokenType2, Token2, Language2, Theme2, Client2, TextStatic2, ClientLanguage2, ClientTheme2, Page2
...
class Client2Admin(SortableAdminBase, admin.ModelAdmin):
    ...
    """
    def get_languages(self, obj):
        return ", ".join(lang.id for lang in obj.client_languages2.all())
    get_languages.short_description = "Languages"

    def get_themes(self, obj):
        return ", ".join(theme.id for theme in obj.client_themes2.all())
    get_themes.short_description = "Themes"
