...
raw_texts = [
            {'id': 'mycard', 'client': 'ZZZ999', 'text': {'en': 'BahCard', 'fr': 'frMy Card'}},
            {'id': 'mycard', 'client': 'ABC123', 'text': {'en': 'My Card', 'fr': 'frMy Card'}},
            {'id': 'mybadge', 'client': 'ABC123', 'text': {'en': 'My Badge2', 'fr': 'frMy Badge'}},
            {'id': 'mysubtitle', 'client': 'ABC123', 'text': {'en': 'My Subtitle', 'fr': 'frMy Subtitle'}},
            {'id': 'mycardtext', 'client': 'ABC123', 'text': {'en': 'A card component has a figure, a body part, and inside body there are title and actions parts', 'fr': 'frA card component has a figure, a body part, and inside body there are title and actions parts'}},
            {'id': 'buynow', 'client': 'ABC123', 'text': {'en': 'Buy Now', 'fr': 'frBuy'}},
            {'id': 'callus', 'client': 'ABC123', 'text': {'en': 'Call Us', 'fr': 'frCall'}},
            {'id': 'myhero', 'client': 'ABC123', 'text': {'en': 'My Hero', 'fr': 'frMy Hero'}},            
            {'id': 'acctit1', 'client': 'ABC123', 'text': {'en': 'How do I create an account?', 'fr': 'frHow do I create an account?'}},            
            {'id': 'acctxt1', 'client': 'ABC123', 'text': {'en': 'Click the "Sign Up" button in the top right corner and follow the registration process.', 'fr': 'frClick the "Sign Up" button in the top right corner and follow the registration process.'}},            
            {'id': 'acctit2', 'client': 'ABC123', 'text': {'en': 'I forgot my password. What should I do?', 'fr': 'frI forgot my password. What should I do?'}},            
            {'id': 'acctxt2', 'client': 'ABC123', 'text': {'en': 'Click on "Forgot Password" on the login page and follow the instructions sent to your email.', 'fr': 'frClick on "Forgot Password" on the login page and follow the instructions sent to your email.'}},            
            {'id': 'acctit3', 'client': 'ABC123', 'text': {'en': 'How do I update my profile information?', 'fr': 'frHow do I update my profile information?'}},            
            {'id': 'acctxt3', 'client': 'ABC123', 'text': {'en': 'Go to "My Account" settings and select "Edit Profile" to make changes.', 'fr': 'frGo to "My Account" settings and select "Edit Profile" to make changes.'}},            
            {'id': 'nb_title', 'client': 'ABC123', 'text': {'en': 'v2My Django Core Lite-Client', 'fr': 'frV2My Django Core Lite-Client'}},
]
...
class HomeZappView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if pkey:
            ...
            client = 'ZZZ999'  # Default root client
        ...
        client_nb_items = [
            {"id": "id1", "parent": "",      "order": 3},
            {"id": "id2", "parent": "",      "order": 2},
            {"id": "id3", "parent": "",      "order": 1},
        ...
        context['raw_texts'] = sorted(raw_texts, key=lambda x: x['client'])
